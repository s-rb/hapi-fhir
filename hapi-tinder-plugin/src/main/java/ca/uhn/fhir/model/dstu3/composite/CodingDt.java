...
public class CodingDt extends BaseCodingDt implements ICompositeDatatype, org.hl7.fhir.instance.model.api.IBaseCoding, Cloneable {
	...
	public CodingDt(BaseCodingDt theCoding) {
		this(
				theCoding.getSystemElement().getValueAsString(),
				theCoding.getCodeElement().getValue());
	}
	...
	public boolean isEmpty() {
		return super.isBaseEmpty()
				&& ca.uhn.fhir.util.ElementUtil.isEmpty(mySystem, myVersion, myCode, myDisplay, myUserSelected);
	}

	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(
				theType, mySystem, myVersion, myCode, myDisplay, myUserSelected);
	}
